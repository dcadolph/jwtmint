...
//
// Env naming convention: a flag named "default-issuer" maps to JWTMINT_DEFAULT_ISSUER.
...
// EnvPrefix is prepended to every environment variable jwtmint reads.
const EnvPrefix = "JWTMINT"
...
// Example: "default-issuer" -> "JWTMINT_DEFAULT_ISSUER".
